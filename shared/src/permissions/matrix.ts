...
/**
 * Permission là DATA, không phải chuỗi if-else.
 * Một nguồn duy nhất cho cả backend (enforce) lẫn frontend (ẩn/hiện nút).
 * Backend vẫn là nơi enforce thật; frontend chỉ dùng để hiển thị.
 */
