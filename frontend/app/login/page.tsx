      ...
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="mt-6">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full mt-4 bg-white hover:bg-gray-50 disabled:bg-gray-100 disabled:cursor-not-allowed border border-gray-300 text-gray-700 font-semibold py-2 px-4 rounded-lg transition duration-200 flex items-center justify-center gap-2"
          >
